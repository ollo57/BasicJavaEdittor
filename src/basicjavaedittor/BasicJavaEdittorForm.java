...
//SUPER OBVIOUS COMMENT TO CHECK IF PUSH WORKED
...
//random comment change for git add -A && git commit -m "$(date +'%Y-%m-%d %H:%M:%S') - auto commit" && git push test
    ...
    // BasicJavaEdittorForm.java (Add this new method)
    public void openFile() {
        ...
        if (retValue == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                curFile = f; // Store the current file for future saves
                setTitle("JWebEdit - " + f.getAbsolutePath());
    ...
    // Add this new method to the end of your class, near saveFile() and openFile()

  public void printFile() {
      try {
          // The print method displays the print dialog and handles printing the document content
          boolean complete = jTextPane1.print();
          if (complete) {
              JOptionPane.showMessageDialog(this, "Printing Complete", "Printer Info", JOptionPane.INFORMATION_MESSAGE);
          } else {
              // This is usually triggered if the user cancels the print job
              JOptionPane.showMessageDialog(this, "Printing Cancelled", "Printer Info", JOptionPane.INFORMATION_MESSAGE);
          }
